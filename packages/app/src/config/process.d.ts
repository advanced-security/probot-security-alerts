...
declare global {
  namespace NodeJS {
    interface ProcessEnv {
      ...
      /**
       * The AWS session token for retrieving secrets from AWS Secret Manager
       */
      AWS_SESSION_TOKEN?: string;
      /** 
       * ARN reference to a secret in AWS Secret Manager (AWS only) 
       * @example 'arn:aws:secretsmanager:us-east-1:123456789012:secret:my-secret-1234Ab'
      */
      PRIVATE_KEY_ARN?: string;
